...
#define WHEEL_FACTOR_MM 1.276          /* Calculated, see below */
...
we have 4 tick per rotation

-> (2*pi*39mm)/(48/1*4) = 1.276 mm/tick - Length the robot travels per
										   divided tick
...
#define distSensFwd     PINF0   /* Forward sensor connected to PA3      */
#define distSensLeft    PINF1	/* Left sensor connected to PA4			*/
...
/* Motor encoder                                                        */
#define encoderPinLeft  PIND2       /*   Left encoder connected to PD3  */
#define encoderPinRight PIND3       /*   Right encoder connected to PD2 */
#define leftWheelCount INT2_vect    /* Interrupt vector for PD3         */
#define rightWheelCount INT3_vect   /* Interrupt vector for PD2         */
